...
public class Tests {
    ...
    public void calculoConPromoCaducada() {
        Producto prod1 = new Producto("1", "termo", "luminagro", new Categoria("bazar"), 100);
        Producto prod2 = new Producto("2", "zapatillas", "nike", new Categoria("ropa"), 100);
        Producto prod3 = new Producto("3", "mochila", "nose", new Categoria("alguna"), 100);
        Producto prod4 = new Producto("4", "campera", "nose", new Categoria("ropa"), 100);
        Producto prod5 = new Producto("5", "mate", "nose", new Categoria("artesanal"), 100);
        ...
        List<AbstractCobrable> tarjetas = new ArrayList<>();
    ...
    public void calcularConPromoAcme() {
        Producto prod1 = new Producto("1", "termo", "luminagro", new Categoria("bazar"), 100);
        Producto prod2 = new Producto("2", "zapatillas", "nike", new Categoria("ropa"), 100);
        Producto prod3 = new Producto("3", "mochila", "acme", new Categoria("alguna"), 100);
        Producto prod4 = new Producto("4", "campera", "acme", new Categoria("ropa"), 100);
        Producto prod5 = new Producto("5", "mate", "acme", new Categoria("artesanal"), 100);
    ...
    public void calcularConDosPromos() {
        Producto prod1 = new Producto("1", "termo", "luminagro", new Categoria("bazar"), 100);
        Producto prod2 = new Producto("2", "zapatillas", "nike", new Categoria("ropa"), 100);
        Producto prod3 = new Producto("3", "mochila", "Comarca", new Categoria("alguna"), 100);
        Producto prod4 = new Producto("4", "campera", "Comarca", new Categoria("ropa"), 100);
        Producto prod5 = new Producto("5", "mate", "Comarca", new Categoria("artesanal"), 100);;
    ...
    public void crearProductoValido() {
        assertThrows(RuntimeException.class, () -> new Producto("1", null, "luminagro", new Categoria("bazar"), 100));
        assertThrows(RuntimeException.class, () -> new Producto("1", "termo", null, new Categoria("bazar"), 100));
